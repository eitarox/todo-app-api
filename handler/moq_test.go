...
//			RegisterUserFunc: func(ctx context.Context, name string, password string, role entity.Role) (*entity.User, error) {
...
func (mock *RegisterUserServiceMock) RegisterUser(ctx context.Context, name string, password string, role entity.Role) (*entity.User, error) {
